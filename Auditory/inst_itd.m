function itd = inst_itd(l,r,fs)
%INST_ITD Calculate instantaneous ITD
%
%   ITD = INST_ITD(L,R,FS) calculates the instantaneous ITD of the input
%   vectors L and R (sampled at frequency FS). The vectors should be
%   narrow-band signals, such as those output by a filterbank.
%   
