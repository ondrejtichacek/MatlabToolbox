...
%
%   CONT = GET_CONTENTS(DIRECTORY) returns the files and folders in a
...
%   array (string).
% 
%   CONT = GET_CONTENTS(DIRECTORY,'PARAMETER',VALUE) allows search options
%   to be specified. The options include:
%       'rec'       {false} | true
...
% 
%   [CONT,DIRFLAG] = GET_CONTENTS(...) returns a logical array DIRFLAG, the
%   same size as CONT, indicating whether each element is a directory.
% 
%   Examples
% 
%       Ex. 1
