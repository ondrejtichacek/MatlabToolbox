function x_oct = smooth_spectrum(X,f,Noct)
%SMOOTH_SPECTRUM Apply 1/N-octave smoothing to a frequency spectrum
% 
%   X_OCT = SMOOTH_SPECTRUM(X,F,NOCT) applies 1/NOCT-octave smoothing to
%   the frequency spectrum contained in vector X sampled at frequencies
%   in vector F. X can be a log-, magnitude-, or power-spectrum. Setting
%   Noct to 0 results in no smoothing.
%   
%   Algorithm
%   
