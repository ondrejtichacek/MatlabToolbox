...
% 
%   Y = VSMOOTH(X,FRAME) smooths the input vector X by calculating the
%   running RMS over a series of frames. FRAME specifies the frame
...
% 
%   Y = VSMOOTH(X,FRAME,MODE) allows the user to specify a different
%   mathematical smoothing function in MODE. The options are:
%   
