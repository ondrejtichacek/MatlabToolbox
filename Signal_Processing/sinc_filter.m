...
% 
%   Y = SINC_FILTER(X,WN) applies a near-ideal low-pass or band-pass
...
%   kernel.
% 
%   Y = SINC_FILTER(X,WN,N) allows the filter length to be specified. The
...
%   
%   Y = SINC_FILTER(X,WN,N,DIM) applies the specified filter along the
%   dimension DIM.
%   
%   Y = SINC_FILTER(X,WN,[],DIM) applies the specified filter along the
